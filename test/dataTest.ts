...
let alltd = [
  {
    ...
    actions: {
      decrement: {
        ...
        description:
          'Decrementing the temperature of the room with 0 to 5 increments',
      },
      increment: {
        forms: [
          {
        ...
        description:
          'Incrementing the temperature of the room with 0 to 5 increments',
      },
    },
    ...
    description:
      'A Thing to control the temperature of the room and also get alerts in too high temperatures',
    securityDefinitions: {
      basic_sc: {
        scheme: 'basic',
      },
...
async function initializeDB() {
  ...
  await client.query(
    'CREATE TABLE thingd (idt serial PRIMARY KEY,td jsonb NOT NULL)',
  );
